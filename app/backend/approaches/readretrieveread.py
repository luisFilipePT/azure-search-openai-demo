...
class ReadRetrieveReadApproach(Approach):
    ...
    template_prefix = \
"You are an intelligent finacial analyst assistant helping stakeholders understand financial reports. " \
...
Thought: {agent_scratchpad}"""
    ...
    CognitiveSearchToolDescription = "useful for searching the Mercedes financial reports."
